...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getCompteControllerService()
    {
        ...
        $this->services['App\\Controller\\CompteController'] = $instance = new \App\Controller\CompteController(($this->services['security.token_storage'] ?? $this->getSecurity_TokenStorageService()));
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('qtz5jAZ-VX', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('u0iiKTKdkg', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    /**
     * Gets the private '.service_locator.Zq3EYtj' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_Zq3EYtjService()
    {
        return $this->privates['.service_locator.Zq3EYtj'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\CompteController::compteNew_Partenaire' => ['privates', '.service_locator.CoC3nYr', 'get_ServiceLocator_CoC3nYrService', false],
            'App\\Controller\\CompteController::compte_PartenaireExistent' => ['privates', '.service_locator.x8FmIZ0', 'get_ServiceLocator_X8FmIZ0Service', false],
            'App\\Controller\\DepotController::faire_depot' => ['privates', '.service_locator.x8FmIZ0', 'get_ServiceLocator_X8FmIZ0Service', false],
            'App\\Controller\\CompteController:compteNew_Partenaire' => ['privates', '.service_locator.CoC3nYr', 'get_ServiceLocator_CoC3nYrService', false],
            'App\\Controller\\CompteController:compte_PartenaireExistent' => ['privates', '.service_locator.x8FmIZ0', 'get_ServiceLocator_X8FmIZ0Service', false],
            'App\\Controller\\DepotController:faire_depot' => ['privates', '.service_locator.x8FmIZ0', 'get_ServiceLocator_X8FmIZ0Service', false],
        ], [
            'App\\Controller\\CompteController::compteNew_Partenaire' => '?',
            'App\\Controller\\CompteController::compte_PartenaireExistent' => '?',
            'App\\Controller\\DepotController::faire_depot' => '?',
            'App\\Controller\\CompteController:compteNew_Partenaire' => '?',
            'App\\Controller\\CompteController:compte_PartenaireExistent' => '?',
            'App\\Controller\\DepotController:faire_depot' => '?',
        ]);
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-VdYkHSlPa', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4pVdscw70d', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('prw0SZ876Q', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8uJPTcZdO4', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('oftMpGCOYx', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mC-U0WGVe-', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('igRTQyik8p', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
